/*
 *
 *  $Id: GettingStarted_Yocto_Temperature.java 58172 2023-11-30 17:10:23Z martinm $
 *
...
public class GettingStarted_Yocto_Temperature extends Activity implements OnItemSelectedListener
{
    ...
    protected void onStart()
    {
        ...
        try {
            ...
            while (module != null) {
                if (module.get_productName().equals("Yocto-Temperature")) {
    ...
    final Runnable r = new Runnable()
    {
        ...
        {
            if (serial != null) {
                YTemperature temp_sensor = YTemperature.FindTemperature(serial + ".temperature");
                try {
