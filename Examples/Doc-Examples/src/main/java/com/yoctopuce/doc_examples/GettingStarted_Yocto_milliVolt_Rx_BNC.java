/*
 *
 *  $Id: GettingStarted_Yocto_milliVolt_Rx_BNC.java 58172 2023-11-30 17:10:23Z martinm $
 *
...
public class GettingStarted_Yocto_milliVolt_Rx_BNC extends Activity implements OnItemSelectedListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.gettingstarted_yocto_millivolt_rx_bnc);
    ...
    protected void onStart()
    {
        ...
        try {
            ...
            while (module != null) {
                if (module.get_productName().equals("Yocto-milliVolt-Rx-BNC")) {
