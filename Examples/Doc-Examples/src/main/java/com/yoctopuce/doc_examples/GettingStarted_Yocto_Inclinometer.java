...
public class GettingStarted_Yocto_Inclinometer extends Activity implements OnItemSelectedListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.gettingstarted_yocto_inclinometer);
    ...
    protected void onStart()
    {
        ...
        try {
            ...
            while (module != null) {
                if (module.get_productName().equals("Yocto-Inclinometer")) {
        ...
        public void run()
        {
            if (serial != null) {
                ...
                try {
                 ...
                 YTilt tilt3 = YTilt.FindTilt(serial + ".tilt3");
                try {
                    TextView view = (TextView) findViewById(R.id.tilt3field);
                    view.setText(String.format("%.1f %s", tilt3.getCurrentValue(), tilt3.getUnit()));
                } catch (YAPI_Exception e) {
                    e.printStackTrace();
                }
