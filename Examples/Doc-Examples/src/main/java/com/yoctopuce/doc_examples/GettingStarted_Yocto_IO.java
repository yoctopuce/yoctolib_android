/*
 *
 *  $Id: GettingStarted_Yocto_IO.java 58172 2023-11-30 17:10:23Z martinm $
 *
...
public class GettingStarted_Yocto_IO extends Activity implements OnItemSelectedListener {
    ...
    protected void onStart() {
        ...
        try {
            ...
            while (module != null) {
                if (module.get_productName().equals("Yocto-IO")) {
        ...
        public void run() {
            if (serial != null) {
                ...
                try {
                    ...
                    _outputdata = (_outputdata + 1) % 4; // cycle ouput 0..3
