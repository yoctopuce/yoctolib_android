/*********************************************************************
 *
 * $Id: YUSBPkt.java 12427 2013-08-20 16:00:19Z seb $
 *
...
public class YUSBPkt  {
	...
	protected static class NotificationDecoder
	{
		...
		public String getSerial() throws YAPI_Exception
		{
		    if (serial==null)
		        throw new YAPI_Exception(YAPI.IO_ERROR,"Notification has invalid serial");
			return serial;
		}
